...
export default defineEventHandler(async (event) => {
  ...
  const [result] = await db
    ...
    .values({
      ...
      matchNotificationChannel: body.matchNotificationChannel ?? 'in_app',
      minReadinessScore: body.minReadinessScore ?? 70,
      matchWeights: body.matchWeights ?? null,
      consentExpiryEnabled: body.consentExpiryEnabled ?? false,
      consentExpiryDays: body.consentExpiryDays ?? 90,
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        ...(body.matchNotificationChannel !== undefined && { matchNotificationChannel: body.matchNotificationChannel }),
        ...(body.minReadinessScore !== undefined && { minReadinessScore: body.minReadinessScore }),
        ...(body.matchWeights !== undefined && { matchWeights: body.matchWeights ?? null }),
        ...(body.consentExpiryEnabled !== undefined && { consentExpiryEnabled: body.consentExpiryEnabled }),
    ...
    .returning({
      ...
      consentExpiryEnabled: orgSettings.consentExpiryEnabled,
      consentExpiryDays: orgSettings.consentExpiryDays,
