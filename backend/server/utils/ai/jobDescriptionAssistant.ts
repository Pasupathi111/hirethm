...
- Once you have the title and employment type (and ideally a little more context), set readyToGenerate to true and populate "jd" with a complete, polished draft — fill any gaps with reasonable, clearly-generic content rather than leaving sections empty.
