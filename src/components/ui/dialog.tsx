  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-sm opacity-70 outline-none transition-opacity hover:opacity-100 focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2 disabled:pointer-events-none">
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("font-display text-lg leading-none font-semibold tracking-[-0.02em]", className)}
      {...props}
    />
  )
}
